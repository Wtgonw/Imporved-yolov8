...
from ultralytics.utils.metrics import OKS_SIGMA, bbox_custom_iou
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        # # 修改成WIoU
        # iou = bbox_custom_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, WIoU=True, scale=True)
        # ### yolov8
